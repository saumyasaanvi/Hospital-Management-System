                        ...
                        <Card.Body>
                            <Form>
                                ...
                                <Form.Group as={Col}>
                                    ...
                                    <Form.Control type="number" placeholder="phone No." id="phoneNo"
                                        onChange={(event) => setFormData({ ...formData, phoneNo: event.target.value })} />
                                </Form.Group>
                                <Form.Group as={Col} className="mb-3">
                                ...
                                <Form.Group as={Col} className="mb-3">
                                    ...
                                    <Form.Control as="textarea" placeholder="Consultation" id="aptNotes"
